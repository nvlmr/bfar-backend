...
<head>
    <meta charset="UTF-8">
    <title>Edit Researcher - CLSD Admin</title>
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-user-edit"></i> Edit Researcher</h1>
        <span>
    ...
    <div class="form-container">
        <div class="form-header">
            <h2><i class="fas fa-user-graduate"></i> Edit: <?= htmlspecialchars($researcher->first_name . ' ' . $researcher->last_name) ?></h2>
        ...
        <form action="<?= BASE_URL ?>/admin/research-team/update/<?= $researcher->id ?>" method="POST" enctype="multipart/form-data">
            <div class="form-grid">
                <!-- First Name -->
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="<?= isset($_SESSION['old']['first_name']) ? htmlspecialchars($_SESSION['old']['first_name']) : htmlspecialchars($researcher->first_name) ?>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           name="middle_name" 
                           class="form-control"
                           value="<?= isset($_SESSION['old']['middle_name']) ? htmlspecialchars($_SESSION['old']['middle_name']) : htmlspecialchars($researcher->middle_name ?? '') ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="<?= isset($_SESSION['old']['last_name']) ? htmlspecialchars($_SESSION['old']['last_name']) : htmlspecialchars($researcher->last_name) ?>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <select id="suffix" name="suffix" class="form-control">
                        ...
                        <option value="Jr." <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'Jr.' ? 'selected' : '' ?>>Jr.</option>
                        <option value="Sr." <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'Sr.' ? 'selected' : '' ?>>Sr.</option>
                        <option value="II" <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'II' ? 'selected' : '' ?>>II</option>
                        <option value="III" <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'III' ? 'selected' : '' ?>>III</option>
                        <option value="IV" <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'IV' ? 'selected' : '' ?>>IV</option>
                        <option value="V" <?= (isset($_SESSION['old']['suffix']) ? $_SESSION['old']['suffix'] : ($researcher->suffix ?? '')) == 'V' ? 'selected' : '' ?>>V</option>
                    </select>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="email" 
                           ...
                           value="<?= isset($_SESSION['old']['email']) ? htmlspecialchars($_SESSION['old']['email']) : htmlspecialchars($researcher->email) ?>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="<?= isset($_SESSION['old']['designation']) ? htmlspecialchars($_SESSION['old']['designation']) : htmlspecialchars($researcher->designation) ?>"
                           placeholder="e.g., Professor, Research Fellow, etc."
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           name="department" 
                           class="form-control"
                           value="<?= isset($_SESSION['old']['department']) ? htmlspecialchars($_SESSION['old']['department']) : htmlspecialchars($researcher->department ?? '') ?>"
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" 
                           ...
                           value="<?= isset($_SESSION['old']['institution']) ? htmlspecialchars($_SESSION['old']['institution']) : htmlspecialchars($researcher->institution) ?>"
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="research_interest" 
                              ...
                              class="form-control" 
                              rows="4"
                              placeholder="Describe their research interests, expertise, etc."><?= isset($_SESSION['old']['research_interest']) ? htmlspecialchars($_SESSION['old']['research_interest']) : htmlspecialchars($researcher->research_interest ?? '') ?></textarea>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <div class="current-image">
                        <img src="<?= BASE_URL ?>/uploads/research/<?= $researcher->image ?>" alt="<?= htmlspecialchars($researcher->first_name) ?>">
                        <p><i class="fas fa-info-circle"></i> Upload a new image to replace this one</p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="form-group full-width">
                    <label class="form-label">
                        <i class="fas fa-image"></i> <?= $researcher->image ? 'Update' : 'Upload' ?> Profile Image
                    </label>
                    <div class="image-upload-container" onclick="document.getElementById('image').click()">
                        <i class="fas fa-cloud-upload-alt"></i>
                        <p>Click to <?= $researcher->image ? 'change' : 'upload' ?> profile image</p>
                ...
                <div class="form-group full-width">
                    <div class="checkbox-group">
                        <input type="checkbox" 
                               ...
                               name="status" 
                               value="1"
                               <?= (isset($_SESSION['old']['status']) ? $_SESSION['old']['status'] : ($researcher->status ?? 0)) == 1 ? 'checked' : '' ?>>
                        <label for="status">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i class="fas fa-save"></i> Update Researcher
                </button>
            </div>
        </form>
    </div>
