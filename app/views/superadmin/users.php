...
<div class="sidebar">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-links show" id="manageMenu">
            <a href="<?= BASE_URL ?>/superadmin/users" class="active">
    ...
    <div class="content-area">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td id="user-action-<?= $user['id'] ?>">
                    <?php if ($user['status'] === 'active'): ?>
                        <button class="btn-danger-modern"
                            onclick="confirmDeactivate(<?= $user['id'] ?>, '<?= htmlspecialchars($fullName, ENT_QUOTES) ?>')">
                            <i class="fas fa-ban"></i> Deactivate
                        </button>
                    <?php else: ?>
                        <button class="btn-success-modern"
                            onclick="confirmActivate(<?= $user['id'] ?>, '<?= htmlspecialchars($fullName, ENT_QUOTES) ?>')">
...
function confirmDeactivate(id, name) {
    ...
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-exclamation-triangle" style="color: #ef4444;"></i> Deactivate User';
...
function confirmActivate(id, name) {
    ...
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-check-circle" style="color: #10b981;"></i> Activate User';
...
document.getElementById('confirmBtn')?.addEventListener('click', function() {
    ...
    closeModal();
    showToast(`User ${currentAction}d successfully`, 'success');
